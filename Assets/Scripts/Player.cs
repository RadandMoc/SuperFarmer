...
public class Player
{
	Dictionary<IAnimal, int> numOfAnimals;
	string nickName;
	byte? turnOfWin = null;
	static byte playersWon = 0; // number of players who won the game

	public Dictionary<IAnimal, int> NumOfAnimals { get => numOfAnimals; set => numOfAnimals = value; }
	public string NickName { get => nickName; set => nickName = value; }
	public byte? TurnOfWin { get => turnOfWin; set => turnOfWin = value; }
	public static byte PlayersWon { get => playersWon; set => playersWon = value; }
	...
	public Player(int numOfPlayers, string nick, byte? turnOfWin) : this()
	{
		if (numOfPlayers == 0)
